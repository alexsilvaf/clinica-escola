...
[Início e recorte atual](README.md) · [Documentação](documentacao/README.md) · [Padrão Markdown](documentacao/guia-markdown.md)

## 1 — Desenvolver a documentação
...
- Fibonacci (Quando se quer desenvolver logo)
- WCAG (Acessibilidade)
- Heurísticas de Nielsen (Usabilidade/UX)
- Teoria das cores
- Estratégias de SEO
